...
def main() -> None:
    ...
    ninja_defs: list[tuple[str, list[int]]] = [
        ...
        # SOM1C–SOM4C: original running-jump somersault, four tucked rotations.
        ("somersault_1", nina_maps["K46352"]),
        ("somersault_2", nina_maps["K46413"]),
        ("somersault_3", nina_maps["K46455"]),
        ("somersault_4", nina_maps["K46517"]),
